...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:cfdi="http://www.sat.gob.mx/cfd/3" xmlns:cce11="http://www.sat.gob.mx/ComercioExterior11" xmlns:donat="http://www.sat.gob.mx/donat" xmlns:divisas="http://www.sat.gob.mx/divisas" xmlns:implocal="http://www.sat.gob.mx/implocal" xmlns:leyendasFisc="http://www.sat.gob.mx/leyendasFiscales" xmlns:pfic="http://www.sat.gob.mx/pfic" xmlns:tpe="http://www.sat.gob.mx/TuristaPasajeroExtranjero" xmlns:nomina12="http://www.sat.gob.mx/nomina12" xmlns:registrofiscal="http://www.sat.gob.mx/registrofiscal" xmlns:pagoenespecie="http://www.sat.gob.mx/pagoenespecie" xmlns:aerolineas="http://www.sat.gob.mx/aerolineas" xmlns:valesdedespensa="http://www.sat.gob.mx/valesdedespensa" xmlns:consumodecombustibles="http://www.sat.gob.mx/consumodecombustibles" xmlns:notariospublicos="http://www.sat.gob.mx/notariospublicos" xmlns:vehiculousado="http://www.sat.gob.mx/vehiculousado" xmlns:servicioparcial="http://www.sat.gob.mx/servicioparcialconstruccion" xmlns:decreto="http://www.sat.gob.mx/renovacionysustitucionvehiculos" xmlns:destruccion="http://www.sat.gob.mx/certificadodestruccion" xmlns:obrasarte="http://www.sat.gob.mx/arteantiguedades" xmlns:ine="http://www.sat.gob.mx/ine" xmlns:iedu="http://www.sat.gob.mx/iedu" xmlns:ventavehiculos="http://www.sat.gob.mx/ventavehiculos" xmlns:terceros="http://www.sat.gob.mx/terceros" xmlns:pago10="http://www.sat.gob.mx/Pagos" xmlns:detallista="http://www.sat.gob.mx/detallista" xmlns:ecc12="http://www.sat.gob.mx/EstadoDeCuentaCombustible12" xmlns:consumodecombustibles11="http://www.sat.gob.mx/ConsumoDeCombustibles11" xmlns:gceh="http://www.sat.gob.mx/GastosHidrocarburos10" xmlns:ieeh="http://www.sat.gob.mx/IngresosHidrocarburos10" xmlns:cartaporte="http://www.sat.gob.mx/CartaPorte" xmlns:cartaporte20="http://www.sat.gob.mx/CartaPorte20">
  ...
  <!-- 
	...
	-->
	<xsl:include href="/xslt/common/EstadoDeCuentaCombustible/ecc11.xslt"/>
	<xsl:include href="/xslt/common/donat/donat11.xslt"/>
	<xsl:include href="/xslt/common/divisas/divisas.xslt"/>
	<xsl:include href="/xslt/common/implocal/implocal.xslt"/>
	<xsl:include href="/xslt/common/leyendasFiscales/leyendasFisc.xslt"/>
	<xsl:include href="/xslt/common/pfic/pfic.xslt"/>
	<xsl:include href="/xslt/common/TuristaPasajeroExtranjero/TuristaPasajeroExtranjero.xslt"/>
	<xsl:include href="/xslt/common/nomina/nomina12.xslt"/>
	<xsl:include href="/xslt/common/cfdiregistrofiscal/cfdiregistrofiscal.xslt"/>
	<xsl:include href="/xslt/common/pagoenespecie/pagoenespecie.xslt"/>
	<xsl:include href="/xslt/common/aerolineas/aerolineas.xslt"/>
	<xsl:include href="/xslt/common/valesdedespensa/valesdedespensa.xslt"/>
	<xsl:include href="/xslt/common/consumodecombustibles/consumodecombustibles.xslt"/>
	<xsl:include href="/xslt/common/notariospublicos/notariospublicos.xslt"/>
	<xsl:include href="/xslt/common/vehiculousado/vehiculousado.xslt"/>
	<xsl:include href="/xslt/common/servicioparcialconstruccion/servicioparcialconstruccion.xslt"/>
	<xsl:include href="/xslt/common/renovacionysustitucionvehiculos/renovacionysustitucionvehiculos.xslt"/>
	<xsl:include href="/xslt/common/certificadodestruccion/certificadodedestruccion.xslt"/>
	<xsl:include href="/xslt/common/arteantiguedades/obrasarteantiguedades.xslt"/>
	<xsl:include href="/xslt/common/ComercioExterior11/ComercioExterior11.xslt"/>
	<xsl:include href="/xslt/common/ine/ine11.xslt"/>
	<xsl:include href="/xslt/common/iedu/iedu.xslt"/>
	<xsl:include href="/xslt/common/ventavehiculos/ventavehiculos11.xslt"/>
	<xsl:include href="/xslt/common/terceros/terceros11.xslt"/>
	<xsl:include href="/xslt/common/Pagos/Pagos10.xslt"/>
	<xsl:include href="/xslt/common/detallista/detallista.xslt"/>
	<xsl:include href="/xslt/common/EstadoDeCuentaCombustible/ecc12.xslt"/>
	<xsl:include href="/xslt/common/consumodecombustibles/consumodeCombustibles11.xslt"/>
	<xsl:include href="/xslt/common/GastosHidrocarburos10/GastosHidrocarburos10.xslt"/>
	<xsl:include href="/xslt/common/IngresosHidrocarburos10/IngresosHidrocarburos.xslt"/>
	<xsl:include href="/xslt/common/CartaPorte/CartaPorte.xslt"/>
	<xsl:include href="/xslt/common/CartaPorte/CartaPorte20.xslt"/>
